...
namespace GMTSongbook.Controllers
{
    public class ArtistController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ArtistID,StageName,FirstName,LastName")] Artist artist)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ArtistID,StageName,FirstName,LastName")] Artist artist)
        {
            if (ModelState.IsValid)
            {
